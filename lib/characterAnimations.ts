  ...
  return [
    {
      ...
      createdAt: now,
      keyframes: [
        { t: 0, pose: pose({ leftLegA: 0.55, leftShinA: 0.5, rightLegA: -0.55, rightShinA: -0.5, leftArmA: -0.38, rightArmA: 0.38, leftForeA: -0.16, rightForeA: 0.16, bodyLean: 0.035 }) },
        { t: 0.125, pose: pose({ leftLegA: 0.38, leftShinA: 0.12, rightLegA: -0.34, rightShinA: -0.18, leftArmA: -0.28, rightArmA: 0.28, leftForeA: -0.08, rightForeA: 0.08, bodyLean: 0.025, headBob: 1.5 }) },
        { t: 0.25, pose: pose({ leftLegA: 0.08, leftShinA: 0.14, rightLegA: -0.12, rightShinA: 0.12, leftArmA: -0.04, rightArmA: 0.04, leftForeA: 0.06, rightForeA: -0.06, headBob: -1.5 }) },
        { t: 0.375, pose: pose({ leftLegA: -0.3, leftShinA: -0.1, rightLegA: 0.34, rightShinA: 0.2, leftArmA: 0.28, rightArmA: -0.28, leftForeA: 0.12, rightForeA: -0.12, bodyLean: -0.015 }) },
        { t: 0.5, pose: pose({ leftLegA: -0.55, leftShinA: -0.5, rightLegA: 0.55, rightShinA: 0.5, leftArmA: 0.38, rightArmA: -0.38, leftForeA: 0.16, rightForeA: -0.16, bodyLean: -0.035 }) },
        { t: 0.625, pose: pose({ leftLegA: -0.34, leftShinA: -0.2, rightLegA: 0.3, rightShinA: 0.1, leftArmA: 0.28, rightArmA: -0.28, leftForeA: 0.08, rightForeA: -0.08, bodyLean: -0.025, headBob: 1.5 }) },
        { t: 0.75, pose: pose({ leftLegA: -0.12, leftShinA: 0.12, rightLegA: 0.08, rightShinA: -0.28, leftArmA: 0.04, rightArmA: -0.04, leftForeA: -0.06, rightForeA: 0.06, headBob: -1.5 }) },
        { t: 0.875, pose: pose({ leftLegA: 0.34, leftShinA: 0.2, rightLegA: -0.3, rightShinA: -0.1, leftArmA: -0.28, rightArmA: 0.28, leftForeA: -0.12, rightForeA: 0.12, bodyLean: 0.015 }) },
        { t: 1, pose: pose({ leftLegA: 0.55, leftShinA: 0.5, rightLegA: -0.55, rightShinA: -0.5, leftArmA: -0.38, rightArmA: 0.38, leftForeA: -0.16, rightForeA: 0.16, bodyLean: 0.035 }) },
      ],
    },
    {
      id: "starter_jump",
    ...
    },
    {
      ...
      createdAt: now,
      keyframes: [
        { t: 0, pose: pose({ leftArmA: 0.72, rightArmA: -0.72, leftForeA: 0.95, rightForeA: -0.95, bodyLean: 0.01 }) },
        { t: 0.16, pose: pose({ leftArmA: 0.82, rightArmA: -1.65, leftForeA: 1.05, rightForeA: -2.0, headBob: -0.6, headTilt: 0.03, bodyLean: -0.02 }) },
        { t: 0.34, pose: pose({ leftArmA: 0.82, rightArmA: -0.68, leftForeA: 1.02, rightForeA: -0.18, headBob: 1, headTilt: 0.01, bodyLean: 0.02 }) },
        { t: 0.5, pose: pose({ leftArmA: 1.65, rightArmA: -0.82, leftForeA: 2.0, rightForeA: -1.05, headBob: -0.3, headTilt: -0.03, bodyLean: 0.02 }) },
        { t: 0.66, pose: pose({ leftArmA: 0.92, rightArmA: -0.9, leftForeA: 1.12, rightForeA: -1.1, headBob: 0.8, headTilt: 0.015 }) },
        { t: 0.84, pose: pose({ leftArmA: 0.52, rightArmA: -1.48, leftForeA: 0.12, rightForeA: -1.86, headBob: -0.35, headTilt: 0.03, bodyLean: -0.02 }) },
        { t: 1, pose: pose({ leftArmA: 0.72, rightArmA: -0.72, leftForeA: 0.95, rightForeA: -0.95, bodyLean: 0.01 }) },
      ],
    },
    {
      id: "starter_sit",
