...
test("video export paints progress before probing and logs every exact encoder request", () => {
  const exportVideo = bodyBetween("async function startExport", "async function exportBoardImage");
