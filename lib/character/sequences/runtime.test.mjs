...
import { characterSequenceById, characterSequences, kneeToFaceSequence, sampleSequence, sequenceSetupMarks, trenchCoatRevealSequence } from "./index.ts";

const setup = { centerX: 500, groundY: 800, direction: 1 };

test("the shared registry exposes paired and single-character sequences", () => {
  assert.deepEqual(characterSequences.map((sequence) => sequence.id), ["knee-to-face", "trench-coat-reveal"]);
