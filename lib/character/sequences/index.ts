import { explodeSequence } from "./explode.ts";
...
export { explodeSequence } from "./explode.ts";
 ...
 */
export const characterSequences = [kneeToFaceSequence, trenchCoatRevealSequence, explodeSequence] as const satisfies readonly CharacterSequence[];
