    ...
    const frame = (now: number) => {
      try {
        ...
        if (snapshot) {
          ...
          if (weaponState.current?.armed && weaponState.current.shooter && weaponState.current.aim) drawTommyGunHeld(ctx, weaponState.current.shooter, weaponState.current.aim, cam, sf, w, h, 0);
